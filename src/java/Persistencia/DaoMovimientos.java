...
public class DaoMovimientos {
    ...
    public static boolean grabar(Movimientos movimientos) {
        try {
            ...
            ps.setString(1, movimientos.getFecha());
            ps.setDouble(2, movimientos.getCantidad());
            ps.setInt(3, movimientos.getProductos_idProductos());
    ...
    public static List<Movimientos> listar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                movimientos1.setProductos_idProductos(rs.getInt("idproductos"));
        ...
        try (Connection con = cn.conectar(); PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    movimientos.setProductos_idProductos(rs.getInt("idproductos"));
