...
public class ControladorProductos extends HttpServlet {
    ...
    DaoProductos daor = new DaoProductos();
    ...
    private void registrarProductos(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            String nombreproductos = request.getParameter("nombreproductos");
            int plu = Integer.parseInt(request.getParameter("plu"));
            Double cantidad = Double.parseDouble("cantidad");
            int txtcategorias = Integer.parseInt(request.getParameter("txtcategorias"));
            int txtproveedores = Integer.parseInt(request.getParameter("txtproveedores"));
            ...
            producto.setPlu(plu);
            producto.setCategorias_idCategorias(txtcategorias);
            producto.setProveedores_idProveedores(txtproveedores);
    ...
    private void actualizarProductos(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int plu = Integer.parseInt(request.getParameter("plu"));
            Double cantidad = Double.parseDouble("cantidad");
            //int categorias_idAreas = Integer.parseInt(request.getParameter("categorias_idAreas"));
            //  int proveedores_idProveedores = Integer.parseInt(request.getParameter("proveedores_idProveedores"));
            int txtcategorias = Integer.parseInt(request.getParameter("txtcategorias"));
            int txtproveedores = Integer.parseInt(request.getParameter("txtproveedores"));
            Productos productos = new Productos();

            productos.setNombreProductos(nombreproductos);
            productos.setCantidad(cantidad);
            productos.setPlu(plu);
            productos.setCategorias_idCategorias(txtcategorias);
            productos.setProveedores_idProveedores(txtproveedores);
            productos.setIdProductos(ide);

            boolean actualizacionExitosa = DaoProductos.editar(productos);
